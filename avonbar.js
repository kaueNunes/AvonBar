     ...
     fix:function(j){
          ...
          language:function(g,v){
               arr=new Array();var a,f,d,c,b;switch(g){
                    case"pt":
                    a="<a href='http://www.br.avon.com/' class='avon_icon' target='_blank' rel='external'><img src='"+v+"/images_bar/avon.gif' alt='Avon'/></a>";
          ...
          init:function(d,j,v,x){
               ...
               if(document.createElement){
                    ...
                    m.innerHTML='<a href="http://www.br.avon.com/PRSuite/lista_sites.page" class="avon_icon" target="_blank" rel="external"><img src="'+v+'/images_bar/nossos_sites.gif" alt="Nossos Sites" /></a><a href=" http://www.br.avon.com/PRSuite/pr_ebrochure.page" class="avon_icon" target="_blank" rel="external"><img src="'+v+'/images_bar/folheto_virtual.gif" alt="Folheto Virtual" /></a><a href="http://www.br.avon.com/PRSuite/revender_avon.page" class="avon_icon" target="_blank" rel="external"><img src="'+v+'/images_bar/revender.gif" alt="Revender" /></a><a href="http://www.br.avon.com/PRSuite/contact_us_main.page?CURR_URL=contact_us_main.page" class="avon_icon" target="_blank" rel="external"><img src="'+v+'/images_bar/fale_conosco.gif" alt="Fale Conosco" /></a>';
                    r.appendChild(m);
                    r.appendChild(f);
